...
{
   class WorkstationSqlCeInstaller
   {
      public static void InstallDatabase ( string connectionString ) 
      {
         Stream   stream ;
         
         stream =  Assembly.GetExecutingAssembly ( ).GetManifestResourceStream ( Constants.WorkstationDb ) ;
      ...
      {
         public const string WorkstationDb = "CSPacsDatabaseConfigurationDemo.Database.SqlCe.Workstation.sdf" ;
      }
   }
}
