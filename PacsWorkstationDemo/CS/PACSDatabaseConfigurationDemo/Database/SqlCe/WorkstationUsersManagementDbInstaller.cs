...
{
   class WorkstationUsersManagementSqlCeInstaller
   {
      public static void InstallDatabase ( string connectionString ) 
      {
         Stream   stream ;
         
         stream =  Assembly.GetExecutingAssembly ( ).GetManifestResourceStream ( Constants.UserAccessDb ) ;
      ...
      {
         public const string UserAccessDb = "CSPacsDatabaseConfigurationDemo.Database.SqlCe.UserAccess.sdf" ;
      }
   }
}
