...
{
   class WorklistSqlCeInstaller
   {
      public static void InstallDatabase ( string connectionString ) 
      {
         Stream   stream ;
         
         stream =  Assembly.GetExecutingAssembly ( ).GetManifestResourceStream ( Constants.WorklistDb ) ;
      ...
      {
         public const string WorklistDb = "CSPacsDatabaseConfigurationDemo.Database.SqlCe.Worklist.sdf" ;
      }
   }
