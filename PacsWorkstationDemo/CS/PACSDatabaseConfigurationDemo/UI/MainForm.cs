...
namespace MedicalWorkstationConfigurationDemo.UI
{
   public partial class MainForm : Form
   {
      ...
      #region Properties
      public static Configuration ConfigMachine
      {
         get;
         set;
      }

      public static Configuration ConfigGlobalPacs
      {
         get;
         set;
      }
      ...
      public static bool GlobalPacsAlreadyExists
      {
         get;
         set;
      }
      ...
      public static void StoreConnectionStringsCommandLine(List<ConnectionStringSettings> connectionStringSettingList)
      {
         ConfigurationManager.RefreshSection("connectionStrings");
         bool globalPacsConfigChanged = false;

         foreach (ConnectionStringSettings csSetting in connectionStringSettingList)
         {
            AddConnectionString(ConfigGlobalPacs.ConnectionStrings, csSetting);
      ...
      )
      {
         ...
         {
            Program.MyShowError("AddConnectionString Failed");
            throw ex;
         }
      }
      ...
      private static void ConfigureLogging(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureLogging Failed");
            throw ex;
         }
      }

      private static void ConfigureLoggingMachineConfig(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
            LoggingDataAccessConfigurationView loggingSectionView;
      ...
      private static void ConfigureStorage(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureStorage Failed");
            throw ex;
         }
      }

      private static void ConfigureUserManagement(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureUserManagement Failed");
            throw ex;
         }
      }

      private static void ConfigureOptions(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureOptions Failed");
            throw ex;
         }
      }

      private static void ConfigureAeManagement(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureAeManagement Failed");
            throw ex;
         }
      }

      private static void ConfigureAePermissionManagement(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureAePermissionManagement Failed");
            throw ex;
         }
      }


      private static void ConfigurePermissionManagement(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigurePermissionManagement Failed");
            throw ex;
         }
      }


      private static void ConfigureForward(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureForward Failed");
            throw ex;
         }
      }

#if (LEADTOOLS_V19_OR_LATER_MEDICAL_EXTERNAL_STORE) || (LEADTOOLS_V19_OR_LATER)
      private static void ConfigureExternalStore(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureExternalStore Failed");
            throw ex;
         }
      }

#endif // #if (LEADTOOLS_V19_OR_LATER_MEDICAL_EXTERNAL_STORE) || (LEADTOOLS_V19_OR_LATER)         
      private static void ConfigureWorklist(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureWorklist Failed");
            throw ex;
         }
      }

      // Workstation only DLLs
      private static void ConfigureMediaCreation(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureMediaCreation Failed");
            throw ex;
         }
      }

      private static void ConfigureWorkstation(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
         try
         {
         ...
         {
            Program.MyShowError("ConfigureWorkstation Failed");
            throw ex;
         }
      }

#if (LEADTOOLS_V20_OR_LATER)
      private static void ConfigurePatientRightsDataAccess(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
      ...
      private static void ConfigureExportLayoutDataAccess(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
      ...
      private static void ConfigureHL7DataAccess(string productName, string connectionStringName, DefaultConnectionNameType connectionType)
      {
      ...
      public static void RegisterConfigSectionsCommandLine()
      {
         RegisterConfigSectionsCommandLine(true, false, false, false, false);
      }

      public static void RegisterConfigSectionsCommandLine(bool storageServerDbSelected, bool loggingDbSelected, bool storageDbSelected, bool workstationDbSelected, bool storageServerOptionsDbSelected)
      {
         if (storageServerDbSelected)
         {
            string connectionStringName = Program._commandLineOptions.DatabaseName;

            ConfigureLogging(DicomDemoSettingsManager.ProductNameStorageServer, connectionStringName, loggingDbSelected ? DefaultConnectionNameType.None : DefaultConnectionNameType.UseMachineConfig);
            ConfigureStorage(DicomDemoSettingsManager.ProductNameStorageServer, connectionStringName, storageDbSelected ? DefaultConnectionNameType.None : DefaultConnectionNameType.UseMachineConfig);
            ConfigureUserManagement(DicomDemoSettingsManager.ProductNameStorageServer, connectionStringName, workstationDbSelected ? DefaultConnectionNameType.None : DefaultConnectionNameType.UseMachineConfig);
            ...
            if (storageServerOptionsDbSelected)
            {
               // For Load Balancing
            ...
            {
               Program.MyShowError("ConfigGlobalPacs.Save Failed");
               throw ex;
            }
         }
      }
...
#if LEADTOOLS_V20_OR_LATER
            ConfigureHL7DataAccess(DicomDemoSettingsManager.ProductNameStorageServer, __WorklistConnectionString.Name, DefaultConnectionNameType.UseCurrent);
#endif
      ...
      private void InsertWorkstationUser()
      {
         ...
         {
            Program.MyShowError("InsertWorkstationUser Failed: " + exception.Message);
            throw exception;
         }

      }

      public static void InsertStorageServerUser(string storageServerUsername, string storageServerPassword)
      {
         try
         {
            ...
            SecureString userPassword = GetSecureString(storageServerPassword);
            accessAgent.AddUser(storageServerUsername, userPassword, true);
            ...
            {
               optionsAgent.AddUserPermission(permission, storageServerUsername);
            }
         }
         catch (Exception exception)
         {
            Program.MyShowError("InsertStorageServerUser Failed: " + exception.Message);
            throw exception;
         }
      }
      ...
      public static void AddDefaultIodClasses()
      {
         try
         {
            ...
            {
               Program.MyShowError("Failed to read IOD Classes from Leadtools.Dicom.Tables.dll");
            }
         ...
         {
            Program.MyShowError("AddDefaultIodClasses Failed: " + exception.Message);
            throw exception;
         }
      ...
      public static bool VerifyAlreadyExistGlobalPacsConfig()
      {
         ...
         try
         {
            ...
            else if (__CurrentControl == connectionConfiguration1)
            {
               ...
               if (!connectionConfiguration1.IsConnectionStringValid(out connectionErrorMessage, _databaseLocations))
               {
                  ...
                  {
                     Program.MyShowError(connectionErrorMessage);
                  }
            ...
            else if (__CurrentControl == connectionSummary1)
            {
               ...
               if (databaseOptions1.Mode == DbConfigurationMode.Configure)
               {
               ...
               if (databaseOptions1.Mode == DbConfigurationMode.Create)
               {
                  ...
                  if (databaseOptions1.StorageServerDbSelected)
                  {
                     InsertStorageServerUser(databaseOptions1.WorkstationUserName, databaseOptions1.WorkstationUserPassword);
